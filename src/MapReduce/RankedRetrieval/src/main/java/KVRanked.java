...
public class KVRanked {
    ...
    public static class IDFReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Reducer<Text, Text, Text, Text>.Context context)
            ...
            double idfValue = Math.log10(1.0 * 2 / (fileCount));
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setJarByClass(KVRanked.class);
        ...
        job2.setJarByClass(KVRanked.class);
        ...
        job3.setJarByClass(KVRanked.class);
